						...
						<div class="col-md-4">
							<div class="card card-product card-plain">
								<div class="card-header card-header-image">
									<a href="<%=request.getContextPath() %>/product-detail?id=<c:out value="${product.productId }"></c:out>" > <img src="${product.image }" alt="" width="100px" height="350px">
									</a>
								</div>
								<div class="card-body">
									<h4 class="card-title">
									<a href="<%=request.getContextPath() %>/product-detail?id=<c:out value="${product.productId }"></c:out>" >
								...
								<div class="card-footer">
									<div class="price-container">
										<span class="price price-new"> <c:out value="${product.price }"></c:out>$</span>
									</div>
									<div class="stats ml-auto">
										<a type="button" rel="tooltip" title="" href="<%=request.getContextPath() %>/product-detail?id=<c:out value="${product.productId }"></c:out>&action="
			...
			<div class="row">
				<div class="col-md-6 ml-auto mr-auto">
					<div class="text-center">
						...
						<p class="description">Join our newsletter and get news in
							your inbox every week! We hate spam too, so no worries about
							this.</p>
					</div>
