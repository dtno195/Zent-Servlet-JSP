		...
		<div class="container">
			<div class="navbar-translate">
				<a class="navbar-brand"
					href="<%=request.getContextPath()%>/ecommerce?action=search&page=1"><b style="color: orange">Zent Clothes</b></a>
						...
						<div class="col-md-6 col-sm-6">
							<div class="tab-content">
								<div class="tab-pane active" id="product-page1">
									<img src="<%=request.getContextPath() %>/<c:out value="${productId.image }"/>">
								</div>
